...
const Slider = () => {
    ...
    let textStyle = `${mode? "text-dark": "text-light"} font-montserrat font-black text-3xl 2xl:text-[42px] 2xl:w-[1920px] italic`
    let fire = <img className="h-9 2xl:h-10 mr-4" src={fireEmoji} alt="fire" />;

    return (
        <div className={`${mode? "bg-light": "bg-dark"} ${transition} w-full h-24 2xl:h-32 text- overflow-hidden`}>
