      ...
      <Header />
        <div className='w-full h-20 md:h-28'></div>
          <div className='flex flex-col items-center justify-center'>
            ...
            variants={animatePres}
            transition={{ duration: 0.5 }}
            className={`${mode ? 'text-light' : 'text-dark'} ${transition} text-center font-montserrat font-black italic text-3xl sm:text-4xl md:text-6xl 2xl:text-7xl mb-2`}>
              {idiom === 'ES' ? title1ES : title1US}
            </motion.h2>
            ...
            variants={animatePres}
            transition={{ duration: 0.5 }}
            className={`${mode ? 'text-light' : 'text-dark'} ${transition} text-center font-montserrat font-black italic text-3xl sm:text-4xl md:text-6xl 2xl:text-7xl`}>
              {idiom === 'ES' ? title2ES : title2US}
            </motion.h2>
            ...
            variants={animatePres}
            transition={{ duration: 0.5 }}
            className={`${mode ? 'text-light' : 'text-gray-700'} ${transition} text-center font-montserrat font-medium text-sm md:text-lg max-w-[300px] sm:max-w-[450px] md:max-w-[600px] 2xl:max-w-[800px] 2xl:text-2xl mt-4 md:mt-7`}>
